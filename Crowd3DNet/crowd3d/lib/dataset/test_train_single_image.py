...
class TEST_TRAIN_SINGLE_IMAGE(Image_base):
    def __init__(self, train_flag=True,
                 regress_smpl=True, **kwargs):
        super(TEST_TRAIN_SINGLE_IMAGE, self).__init__(train_flag, regress_smpl)
    ...
    def get_image_info(self, index):
        ...
        img_info = {'imgpath': imgpath, 'image': image, 'kp2ds': kp2ds, 'track_ids': None, \
                    ...
                    'hvip2ds': None, 'bbox': None, 'trans': None, 'root_cam': None,'ankle2ds': ankle2ds, 'data_scale':cur_size/512, 'scene_shape': np.array(self.scene_shape)}
        return img_info
...
if __name__ == '__main__':
    ...
    dataset = TEST_TRAIN_SINGLE_IMAGE(train_flag=True, regress_smpl=False)
